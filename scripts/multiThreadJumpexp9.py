...
def TkProssece(*args):
	...
	Squat = tk.Button(root, text="Squat", command=SquatMethod, font=("Monospace",20))
	Squat.grid(row=4,column=3)
	Stand = tk.Button(root, text="Stand", command=StandMethod, font=("Monospace",20))
	Stand.grid(row=5,column=3)
...
def JumpMethod():
	...
	t = time.time() -iniTime
	angles = MotorAngles()
	#x1,x2,y1,y2 = -0.113,-0.113,-0.113,-0.113
	#x1,x2,y1,y2 = 0.0,0.0,-0.16,-0.16
	leg1th1,leg1th2,leg2th1,leg2th2 ,leg3th1,leg3th2,leg4th1,leg4th2\
	= RobotFuncs.actualReference(x1,y1,x2,y2,x3,y3,x4,y4)
	leg1th2 = -20
	leg2th2 = 20
	...
	angles.ang8 = leg4th2
	pub1.publish(angles)
	while time.time()-iniTime-t_start < 0.1:
		iii=10
	x1,x2,y1,y2 = 0.113,0.113,-0.113,-0.113
	leg1th1,leg1th2,leg2th1,leg2th2 ,leg3th1,leg3th2,leg4th1,leg4th2\
	= RobotFuncs.actualReference(x1,y1,x2,y2,x3,y3,x4,y4)
	...
	pawlAng.data = pawls
	pub2.publish(pawlAng)	
	leg3th1 = 104.223826445
	leg4th1 = -104.223826445
	angles.ang1 = leg1th1
	angles.ang2 = leg2th1
	angles.ang3 = leg3th1
	angles.ang4 = leg4th1
	...
	t_start = time.time() -iniTime
	#release pawl 
	while time.time()-iniTime-t_start < 0.05:
		iii=10
...
def SquatMethod():
	global pub1,pub2, pawls, pawlAng,iniTime,rate, angles
	global leg1th1,leg1th2,leg2th1,leg2th2 ,leg3th1,leg3th2,leg4th1,leg4th2
	global x1,x2,x3,x4,y1,y2,y3,y4 
	print "Squat"
	t_start = time.time() -iniTime
	...
	delH = 0.07
	delH1 = 0.05
	while (time.time() -iniTime)- t_start < 4.0:
		delY = ((time.time() -iniTime)- t_start )*delH/4.0
		delY1 = ((time.time() -iniTime)- t_start )*delH1/4.0
		y1,y2 = -0.16 +delY1,-0.16 +delY1
		y3,y4 = -0.16 +delY,-0.16 +delY
		x3,x4 = 0.03,0.03
		x1,x2 = -0.03,-0.03
		print y1
		leg1th1,leg1th2,leg2th1,leg2th2 ,leg3th1,leg3th2,leg4th1,leg4th2\
		...
		pub1.publish(angles)
		rate.sleep()
	y1,y2,y3,y4 = -0.16+delH1, -0.16+delH1, -0.16+delH, -0.16+delH
	leg1th1,leg1th2,leg2th1,leg2th2 ,leg3th1,leg3th2,leg4th1,leg4th2\
	= RobotFuncs.actualReference(x1,y1,x2,y2,x3,y3,x4,y4)
	angles.ang1 = leg1th1
	angles.ang2 = leg2th1
...
def StandMethod():
	...
	print "Stand"
	angles = MotorAngles()
	x1,x2,x3,x4,y1,y2,y3,y4 = 0.0,0.0,0.0,0.0,-0.16,-0.16,-0.16,-0.16
	leg1th1,leg1th2,leg2th1,leg2th2 ,leg3th1,leg3th2,leg4th1,leg4th2\
	= RobotFuncs.actualReference(x1,y1,x2,y2,x3,y3,x4,y4)
	angles.ang1 = leg1th1
	angles.ang2 = leg2th1
